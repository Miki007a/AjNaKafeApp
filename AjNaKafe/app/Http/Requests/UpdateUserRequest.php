...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'password' => [
                'nullable', // Password is optional for profile updates
                'confirmed', // Only validated if password is provided
                Password::min(8)
                    ->letters()
                    ->symbols()
                    ->numbers()
            ],
            'bio' => ['nullable', 'string', 'max:1000'], // Bio field - optional, max 1000 characters
        ];
    }
