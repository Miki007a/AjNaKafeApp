    ...
    public function getMessages($chatId)
    {
        ...
        $messages = Message::where('chat_id', $chatId)
            ...
            ->map(function ($message) {
                // Ensure is_system is included in the response
                ...
                if ($message->is_file) {
                    ...
                    foreach ($files as $file) {
                        ...
                        if (str_contains($fileBasename, '_' . $originalFileName) || 
                            ...
                            $messageData['file_url'] = Storage::url($file);
                            break;
                        }
                    }
                    
                    // Fallback: try direct path if content is the stored filename
                    if (!isset($messageData['file_url'])) {
                ...
                // Ensure is_system is explicitly included
                $messageData['is_system'] = $message->is_system ?? false;
